...
UI_STRINGS: dict[str, str] = {
    ...
    "focus_access_site": "Open this site for 10 minutes",
    "focus_choose_deliberately": "Choose deliberately",
    "focus_pause_seconds": "Pause for {n} seconds",
    "focus_return_to_study": "Return to study",
    ...
    "lesson_activity_handwrite_form": "Write it by hand",
    ...
    "lesson_activity_type_on_keyboard": "Use the keyboard layout",
    "lesson_challenge_hint": "What is incomplete, ambiguous, or factually wrong?",
    "lesson_challenge_replace": "Replace this task",
    "lesson_challenge_task": "This task looks wrong or unclear",
    ...
    "literacy_course_continue": "Continue alphabet course",
    "literacy_course_done": "Reading support is now optional",
    "literacy_course_failed": "The alphabet course could not be started. Try again.",
    "literacy_course_goal": "Learn to read {language} using the {script}",
    "literacy_course_kicker": "Writing system",
    "literacy_course_latin_desc": "A short route through the extra letters, diacritics, and sound distinctions used in this language.",
    "literacy_course_mastered": "You have completed the writing-system route. Pronunciation hints remain available on demand.",
    "literacy_course_new_desc": "Learn the symbols and their sounds, then move from supported examples to reading without romanization.",
    "literacy_course_start": "Start alphabet course",
    "literacy_course_title": "Reading comes first",
    "literacy_course_variant_desc": "A short route through the extra letters, marks, and sound distinctions used in this language.",
    ...
    "ocr_capture_expired": "The captured page is no longer available. Start again from the context menu.",
    ...
    "voice_input_denied": "Microphone access is unavailable.",
    "voice_input_failed": "Could not recognize the recording. Try again.",
    "voice_input_processing": "Recognizing speech…",
    "voice_input_setup_hint": "Click the microphone below, then allow access. This one-time setup enables voice input in the Veksha popup.",
    "voice_input_start": "Use voice input",
    "voice_input_stop": "Stop and recognize",
    "transcription_hide": "Hide pronunciation hint",
    "transcription_show": "Show pronunciation hint",
